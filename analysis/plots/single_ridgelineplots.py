...
LAYOUT_FILE = os.path.join(SCRIPT_DIR, f'ridgelineplots_single.json')
...
fontsize = 12
fontsize_data = 9 if summarize_all else 10
row_factor = 1
col_factor = 1
...
fig = plt.figure(figsize=(15, 2), dpi=DPI, layout='none')
...
fig = plt.figure(figsize=(table_width*2, table_height*2), dpi=DPI, layout='none')
