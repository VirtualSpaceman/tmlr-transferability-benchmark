...
TRANSF_METRICS_TO_NAMES = rodict({
    ...
    'bh3_BEST':         'Back to Bayes',
    'linear_pooling_overall': 'Linear Overall',
    'linear_pooling_per_scorer': 'Linear per Scorer',
...
def main():
    ...
    mm_to_in = (1./25.4)*4
    fig = plt.figure(figsize=(82*mm_to_in, 30*mm_to_in))
    rows, cols = 2, 3  # Change based on desired layout
